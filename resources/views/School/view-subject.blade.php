                ...
                <div class="col-md-8">
                  ...
                  <div class="card shadow-lg">
                    <div class="card-header bg-primary text-white text-center">
                      <h3>Subject Information Details</h3>
                    </div>
                    <div class="card-body">
                      <div class="mb-3">
                        <h5 class="text-muted">Name:</h5>
                        <p class="fs-5 fw-bold" id="info-name">{{ $subject->name }}</p>
                      </div>
                      <div class="mb-3">
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="modal-header">
                      <h5 class="modal-title" id="editSchoolModalLabel">Edit Subject</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                      <!-- Form for Editing School -->
                      <form action="{{ route('school/subject') }}" method="POST" enctype="multipart/form-data"> 
                          @csrf

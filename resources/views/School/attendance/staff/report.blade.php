...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" 
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-3">Staff Attendance Report ({{ \Carbon\Carbon::parse($startDate)->format('M d, Y') }} - {{ \Carbon\Carbon::parse($endDate)->format('M d, Y') }})</h5>
    ...
    <script>
        ...
        $('#filterBtn').on('click', function() {
            ...
            if(startDate && endDate) {
                window.location.href = "{{ route('attendance.staff.report') }}?start_date=" + startDate + "&end_date=" + endDate;
            }
        });
    ...
    <style>
        @media print {
            .page-breadcrumb, .btn, footer, .sidebar, .topbar {

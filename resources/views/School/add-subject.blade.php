        ...
        <div class="container-fluid">
          ...
          <div class="card">
            <div class="card-body wizard-content">
              <h1 class="card-title">Add a new Subject</h1>
              <h6 class="card-subtitle"></h6>
              <form action="{{ route('school/subject') }}" method="post" class="mt-5 p-4 border rounded shadow-sm bg-light" enctype="multipart/form-data">
                  @csrf
                  <div>
                      <h3 class="text-primary mb-4">Add Subject</h3>
                      <section>
                          <div class="mb-3">
                              <label for="userName" class="form-label fw-bold">Subject Name *</label>
                              <input
                                  id="userName"
                                  name="name"
                                  type="text"
                          ...
                          <div class="mb-3">
                            <label for="userName" class="form-label fw-bold">Department (Optional)</label>
                            <select name="department" id="subject" class="form-select">
                              <option selected disabled>Choose a subject for this department (Optional)</option>

                      ...
                      <div class="col-12">
                        <div class="d-flex flex-wrap gap-2">
                          @if ($student->status === 'ACTIVE')
                            <button class="btn btn-warning btn-sm" onclick="confirmStatusChange('{{ url('school/student/change', $student->id) }}')">
                              Deactivate Account
                            </button>
                          @elseif ($student->status === 'DISACTIVATE')
                            <button class="btn btn-success btn-sm" onclick="confirmStatusChange('{{ url('school/student/change', $student->id) }}')">
                              Activate Account
                            </button>
                          @endif
                          ...
                          <button class="btn btn-danger btn-sm" onclick="confirmStatusChange('{{ url('school/student/delete', $student->id) }}')">
                            Delete Student
                          </button>
                        </div>
                      </div>

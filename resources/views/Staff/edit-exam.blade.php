        ...
        <div class="container-fluid">
          ...
          <div class="card">
            <div class="card-body wizard-content">
              <h1 class="card-title">Edit exam: {{ $exam->title }}</h1>
              <h6 class="card-subtitle">Modify the exam details step by step</h6>
              <form id="exam-form" action="{{ route('staff.exams.update', [$class->id, $exam->id]) }}" method="post" class="mt-5" enctype="multipart/form-data"> 
                @csrf
                @method('PUT')
                <div>
                  ...
                  >
                    ...
                    <textarea
                      ...
                      class="form-control"
                      rows="4"
                      placeholder="Add exam description...">{{ old('description', $exam->description) }}</textarea>
                  ...
                  <section>
                    ...
                    <input
                      ...
                      type="datetime-local"
                      class="required form-control"
                      value="{{ old('exam_date_time', $exam->exam_date_time) }}"
                    />
                 ...
                 <!-- Step 3: Exam Options -->
                  ...
                  <section>
                    ...
                    <div class="form-check mb-3">
                      <input 
                        ...
                        value="1"
                        {{ old('show_one_question_at_time', $exam->show_one_question_at_time) ? 'checked' : '' }}
                      >
                  ...
                  <section>
                    ...
                    <textarea
                      ...
                      class="form-control"
                      rows="6"
                      placeholder="Add instructions for students...">{{ old('instructions', $exam->instructions) }}</textarea>
                  ...
                  <section>
                    ...
                    <label for="acceptTerms">
                      I confirm that all the changes are correct and want to update this exam.
                    </label>
                    <button class="btn btn-warning mt-3" type="submit">
                      <i class="fas fa-save"></i> Update Exam
                    </button>
                    <a href="{{ route('staff.exams.show', [$class->id, $exam->id]) }}" class="btn btn-secondary mt-3">
                      Cancel
                    </a>
                  </section>
                </div>

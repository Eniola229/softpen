      ...
      <div class="page-breadcrumb">
        <div class="row">
          <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title">Edit Practice Exam</h4>
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body wizard-content">
            <h1 class="card-title">Edit practice exam: {{ $exam->title }}</h1>
            <h6 class="card-subtitle">Modify the practice exam details step by step</h6>

            <form id="exam-form" action="{{ route('exams.update', [$class->id, $exam->id]) }}" method="post" class="mt-5">
              @csrf
              @method('PUT')
              <div>
                ...
                <section>
                  ...
                  <input id="title" name="title" type="text" class="required form-control" placeholder="e.g., Mathematics Practice Test 1" value="{{ old('title', $exam->title) }}" />
          ...
          <div class="form-group mb-3 mt-2">
              ...
              <select id="subject" name="subject" class="form-control select2" required>
                ...
                <div class="form-group mb-3">
                  ...
                  <textarea id="description" name="description" class="form-control" rows="4" placeholder="Add exam description...">{{ old('description', $exam->description) }}</textarea>
                ...
                <section>
                  ...
                  <input id="duration" name="duration" type="number" class="required form-control" placeholder="e.g., 60" value="{{ old('duration', $exam->duration) }}" min="1" />

                  <label for="total_questions">Total Questions *</label>
                  <input id="total_questions" name="total_questions" type="number" class="required form-control" placeholder="e.g., 20" value="{{ old('total_questions', $exam->total_questions) }}" min="1" />

                  <label for="passing_score">Passing Score (%) *</label>
                  <input id="passing_score" name="passing_score" type="number" class="required form-control" placeholder="e.g., 40" value="{{ old('passing_score', $exam->passing_score) }}" min="0" max="100" />
                ...
                <section>
                  ...
                  <input id="session" name="session" type="text" class="required form-control" value="{{ old('session', $exam->session) }}" />
                ...
                <section>
                  ...
                  <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" id="show_one_question_at_time" name="show_one_question_at_time" value="1" {{ old('show_one_question_at_time', $exam->show_one_question_at_time) ? 'checked' : '' }}>
                  ...
                  <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" id="show_results" name="show_results" value="1" {{ old('show_results', $exam->show_results) ? 'checked' : '' }}>
                  ...
                  <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" id="show_explanations" name="show_explanations" value="1" {{ old('show_explanations', $exam->show_explanations) ? 'checked' : '' }}>
                ...
                <section>
                  ...
                  <textarea id="instructions" name="instructions" class="form-control" rows="6" placeholder="Add instructions for students...">{{ old('instructions', $exam->instructions) }}</textarea>
                ...
                <section>
                  ...
                  <label for="acceptTerms">
                    I confirm that all the changes are correct and want to update this practice exam.
                  </label>
                  <button class="btn btn-warning mt-3" type="submit">
                    <i class="fas fa-save"></i> Update Practice Exam
                  </button>
                  <a href="{{ route('exams.show', [$class->id, $exam->id]) }}" class="btn btn-secondary mt-3">
                    Cancel
                  </a>
                </section>
              </div>

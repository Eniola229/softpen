          ...
          <div class="card-body">
            ...
            <form action="{{ route('questions.store', [$class->id, $exam->id]) }}" method="POST" enctype="multipart/form-data" id="questionForm">
              ...
              <div class="form-group mb-3">
                ...
                <textarea id="question_text" name="question_text" class="form-control" rows="4" placeholder="Enter your question here..." required>{{ old('question_text') }}</textarea>
              </div>
              ...
              <div class="form-group mb-3">
                ...
                <textarea id="explanation" name="explanation" class="form-control" rows="5" placeholder="Provide a detailed explanation for the correct answer. This will help students learn." required>{{ old('explanation') }}</textarea>

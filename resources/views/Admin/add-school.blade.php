        ...
        <div class="container-fluid">
          ...
          <div class="card">
            <div class="card-body wizard-content">
              <h1 class="card-title">Add a new school</h1>
              <h6 class="card-subtitle"></h6>
              <form id="example-form" action="{{ route('admin/schools') }}" method="post" class="mt-5"  enctype="multipart/form-data"> 
                @csrf
                <div>
                  <h3>Privacy</h3>
                  <section>
                  ...
                  <section>
                    <label for="avatar">School Picture *</label>
